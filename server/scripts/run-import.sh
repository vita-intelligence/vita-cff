...
# One-shot import runner. Prompts for the Postgres admin password,
# URL-encodes it, sets DATABASE_URL, installs the local venv deps if
# needed, and runs the raw-materials import script against
# production.
#
...
echo "[step 3/3] running import_raw_materials.py against production..."
