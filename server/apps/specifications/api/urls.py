...
from apps.specifications.api.views import (
    ...
    SpecificationRefreshPricingView,
...
urlpatterns = [
    ...
    path(
        "public/specifications/<uuid:token>/proposal/",
        PublicProposalRenderView.as_view(),
        name="public-specification-proposal",
    ),
]
