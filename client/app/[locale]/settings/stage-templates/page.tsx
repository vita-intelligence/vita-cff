...
import { StageTemplatesTab } from "./stage-templates-tab";


export default async function SettingsStageTemplatesPage({
  params,
}: {
  ...
  // Gate matches the FE tab visibility + backend RBAC. Anyone who
  // lands here without the cap bounces back to the safe default
  // settings surface — the tab itself is already hidden for them,
  // this is defence-in-depth for hand-typed URLs.
  if (
    !hasFlatCapability(organization, "formulations", "manage_stage_templates")
  ) {
