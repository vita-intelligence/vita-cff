...
export function SpecChatPanel({
  ...
  return (
    <Card className="!p-0">
      ...
      >
        {messages === null ? (
          // Brutalist in-panel loader matching the proposal chat
          // panel — uppercase tracked label, neutral tone so it
          // sits on the paper background without competing with
          // real message rows.
